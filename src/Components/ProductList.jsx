...
const ProductList = () => {
  ...
  if (loading) {
    return (
      <p className="text-5xl text-center font-bold text-orange-800 animate-pulse mt-20">
        Loading...
      </p>
    );
  }
    ...
    <>
      ...
      <div className="w-full flex justify-center mt-10 px-4">
        <input
          ...
          className="w-full max-w-md border-2 border-orange-800 focus:border-orange-500 focus:ring-4 focus:ring-orange-200 px-6 py-3 rounded-full text-lg transition-all duration-300 shadow-md placeholder:text-orange-800"
        />
      </div>
