...
const CartItem = ({ CartItems: item, index }) => {
  ...
  return (
    <tr className="text-center bg-orange-100 hover:bg-amber-100 transition duration-200">
      ...
      {/* Item title */}
      <td className="py-4 text-orange-800 font-bold text-lg">
        {item.title}
      </td>
      ...
      <td className="py-4">
        <div className="flex justify-center gap-4">
          ...
          <button
            ...
            className={`${
              item.quantity <= 1
                ? 'cursor-not-allowed opacity-50 border border-amber-500 text-amber-500'
                : 'text-amber-600 border border-amber-600 hover:bg-amber-500 hover:text-white'
